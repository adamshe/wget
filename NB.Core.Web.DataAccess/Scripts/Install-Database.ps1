...
if(-not $DoNotCreateDatabase.IsPresent)
{
    ...
    $createDatabaseCommandLine = $baseOsqlCommandLine + "-Q 'CREATE DATABASE $DatabaseName ON  PRIMARY 
( NAME = N''Earning'', FILENAME = N''D:\SQL2008\MSSQL\Data\Earning.mdf'' , SIZE = 2304KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON ( NAME = N''Earning_log'', FILENAME = N''E:\SQL2008\LOG\Earning_log.LDF'' , SIZE = 576KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)'"

...
namespace NB.Core.Web.UnitTest
{
    ...
    {//^TNX,TQQQ";/*
        ...
        string tickers =  @"LVLT,MNST,SPY,AAPL,YHOO,MSFT,GOOGL,CSCO,BRCM,INTC,QCOM,CYBR,BA,ADBE,HDP,NEWR,WYNN,LVS,TSLA,NFLX,PCLN,AMZN, 
            FB,LNKD,TWTR,BIDU,NTES,CTRP,JD,JMEI,DATA,NOW,GILD,SPLK,NUAN,FCX,FDML,SHW,SSYS,DDD,
            LNG,EOG,APC,GPRO,MCO,DFS,AXP,MA,V,GS,BAC,JPM,
            C,JUNO,KITE,BLUE,GMCR,PCYC,INCY,GEVA,ACAD,TKMR,CELG,REGN,BIIB,ABBV,ICPT,TQQQ,BIB,CURE,KNDI,VRX,TRIP,DIS,WDC,RCL,TSO";
